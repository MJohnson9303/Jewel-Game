...
public class StarOrb extends GameWorldObject implements IDrawable, ISelectable, IMovable, IDeletable
{
	private File starOrbFile;
    ...
    public StarOrb(Point2D objectLocation)
    {
    	starOrbFile = new File("." + File.separator + "Images" + File.separator + "Star Orb.png");
    ...
    //Drawing from the center of the orb. The picture is 120x120.
  	public void draw(Graphics g)
  	{
		...
		try 
		{
			BufferedImage bufferedImage = ImageIO.read(starOrbFile);
	...
	{
		return "Star Orb: loc="+getLocation().getX()+","+getLocation().getY();
	}
